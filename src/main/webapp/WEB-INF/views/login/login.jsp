...
body, html {
    ...
    background-image: linear-gradient(rgb(196, 31, 133), rgb(228, 186, 49));
}
    /* 로그인 창 */
.card-container.card {
    max-width: 350px;
...
.form-signin .form-control:focus {
    border-color: rgb(56, 173, 223);
    outline: 0;
    -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgb(26, 73, 94);
...
.forgot-password {
    color: rgb(21, 174, 240);
}

.forgot-password:hover,
.forgot-password:active,
.forgot-password:focus{
    color: rgb(114, 241, 146);
}
    </style> -->
</head>
