...
<div class="all">
    ...
    <div class="writebody">
        ...
        <div>
            <h3> 해시태그 지정</h3>
            <input class="size" type="text" placeholder="태그를 입력하세요 예시:) #해시 #태그" id="tagInput" value="${hashtagList}">
        ...
        <div> <!-- 관계 게시글 설정-->
            ...
            <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#modalCart" id="modal-block">
                <input class="size" class="tt" type="text" placeholder="관련 문서들" name="relatedBoardList" id="inputRelList" disabled value="${relationList}">
